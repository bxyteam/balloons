...
function procesarReportesDeDatos(
  ...
  console.log("badcounters", bandCounters);
  ...
  console.log("bandArrays", bandArrays);
...
async function initApp() {
  ...
  window.lichome = resultadoProcesadoDeDatos.lichome;
  window.home = resultadoProcesadoDeDatos.home;
  window.pwr = resultadoProcesadoDeDatos.pwr;
  window.iis = resultadoProcesadoDeDatos.iis;
  window.iib = resultadoProcesadoDeDatos.iib;
  ...
  const reporteDeDatosProcessor = procesarReportesDeDatos(
    ...
    estac,
    bande,
    resultadoProcesadoDeDatos.lastz,
    did,
  ...
  window.colsChart = graficosConfigurados.cols;
  ...
  window.smax = reporteDeDatosProcessor.smax;
  window.hactivo = reporteDeDatosProcessor.hactivo;
  window.bemit = graficosConfigurados.bemit;
  window.estalast = resultadoProcesadoWsprBeacon.estalast;
